...
出発点をスタックに入れる
★スタックが空かチェックする。空なら終了
スタックから一つ取り出しし、行ったことあるかチェックする
行ったことがないところであれば、その場所に行ったことにし、その場所からい☆ける場所をスタックに入れる。
★～☆までを繰り返す。
...
出発点をキューにいれる
★キューが空かチェックする。空なら終了
キューから一つ取り出しし、行ったことがあるところかチェックする
行ったことがないところであれば、その場所を行ったことにし、その場☆所からいける場所をスタックに入れる
★～☆までを繰り返す
